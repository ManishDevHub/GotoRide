...
gsap.to(vehiclePanelRef.current,{
  ...
  return (
    <div className="h-screen relative overflow-hidden">
      ...
      <div ref={vehiclePanelRef} className=" fixed w-full z-10 translate-y-full  bottom-0 bg-white px-2 py-8">
       <h5 onClick={()=>{
        setVehiclePanelOpen(false)
       }} className="pb-2 pl-3 text-center absolute w-[93%] top-0 "><i className="text-3xl text-gray-500 ri-arrow-down-wide-line"></i></h5> 
        ...
        <div className="flex w-full border-2 mb-2 active:border-black rounded-xl items-center p-3  justify-between">
          <img
            className="h-12 mr-4"
            src="https://www.svgrepo.com/show/395796/auto-rickshaw.svg"
            alt=""
          />
          <div className=" w-1/2">
            <h4 className="font-medium text-lg">
